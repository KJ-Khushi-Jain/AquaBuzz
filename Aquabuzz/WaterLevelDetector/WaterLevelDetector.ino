...
#define BLYNK_TEMPLATE_ID "TMPL3Yly25jUY"
#define BLYNK_TEMPLATE_NAME "AquaBuzzer"
#define BLYNK_AUTH_TOKEN "ccxFmnniG-Kk-igW-QiZbmN7tyF56olW"

// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[] = "vivo T1";   //WiFi Name
char pass[] = "1234512346";   //WiFi Password

//Set Water Level Distance in CM
int emptyTankDistance = 30 ;  //Distance when tank is empty
int fullTankDistance =  26 ;  //Distance when tank is full (must be greater than 25cm)
